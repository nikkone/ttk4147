...
static void vBasicTaskA(void *pvParameters);
static void vBasicTaskB(void *pvParameters);
static void vBasicTaskC(void *pvParameters);
...
int main()
{
	...
	// start basic task
	xTaskCreate( vBasicTaskA, (signed char * ) "BASICA", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2, NULL);
	xTaskCreate( vBasicTaskB, (signed char * ) "BASICB", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 3, NULL);
	xTaskCreate( vBasicTaskC, (signed char * ) "BASICC", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 4, NULL);
	xTaskCreate( vCpuWork, (signed char * ) "BASICD", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1, NULL);
